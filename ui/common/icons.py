...
_ICONS = {
    ...
    "window-minimize": '<path d="M7 12h10"/>',
    "window-maximize": '<rect x="6" y="6" width="12" height="12" rx="1.8"/>',
    "window-restore": '<path d="M9 5h9a1 1 0 0 1 1 1v9"/><rect x="5" y="9" width="10" height="10" rx="1.8"/>',
    "window-close": '<path d="M8 8l8 8"/><path d="M16 8l-8 8"/>',
    ...
    "tool-subrayador": (
        '<path d="m4 18 11.5-11.5a2.1 2.1 0 0 1 3 0l1 1a2.1 2.1 0 0 1 0 3L8 22H4v-4Z"/>'
